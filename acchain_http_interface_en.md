...
```js
{
    ...
    "transactions": [{
        ...
        "asset": {
            "uiaIssuer": {
                "transactionId": "12372526051670720162",    // transaction id 
                "name": "zhenxi",   // issuer name 
                "desc": "注册资产发行商-测试"   // issuer desc
            }
        },
        "t_id": "12372526051670720162"  // transaction id
    },
    {
...
Description: Here, the `asset` is related to the `type`, 9 <= type <= 14, get different values from the asset according to different type
